        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>how to register correctly
                        <span id="dots">...</span><span id="more"><br>
                    The first letter of the Name <strong>Name</strong> should be the uppercase letter<br>
                      <strong>NickName</strong>  must be lowercase<br>
                        <strong>Email</strong>  must be unique and have @<br>
                          <strong>Age</strong>  must be +18<br>
                            The first letter of the <strong>Password</strong>  should be the uppercase letter
                        </span></p>
